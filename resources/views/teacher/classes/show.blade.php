...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('teacher.classes.enrollments', $class->id) }}" class="btn btn-primary btn-sm me-2">
                <span data-feather="users"></span> Manage Students
            </a>
            <a href="{{ route('teacher.classes.edit', $class->id) }}" class="btn btn-warning btn-sm me-2">
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('teacher.classes.assign-teacher', $class->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-5">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('teacher.classes.unassign-teacher', $assignment->id) }}" method="POST"
