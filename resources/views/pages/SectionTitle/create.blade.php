...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Add Section Title</h5>
        <a href="{{ route('teacher.subjects.show', $subject->id) }}" class="btn btn-secondary btn-sm">
            <span data-feather="arrow-left"></span> Back
        </a>
    </div>

    <div class="card-body">
        <form action="{{ route('teacher.section-titles.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea id="description" name="description"
                    ...
                    rows="3"
                    placeholder="Add a brief description for this section (optional)">{{ old('description') }}</textarea>
                @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-primary" type="submit">
                    <span data-feather="plus"></span> Create Section Title
                </button>
