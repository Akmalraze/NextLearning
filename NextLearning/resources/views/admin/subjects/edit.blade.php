    ...
    <form action="{{ route('admin.subjects.update', $subject->id) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name', $subject->name ?? $subject->subjects_name) }}" required>
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror"
                    value="{{ old('code', $subject->code ?? $subject->subjects_code) }}" required>
                @error('code')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" {{ old('is_active',
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary">
                <span data-feather="save"></span> Update Subject
            </button>
